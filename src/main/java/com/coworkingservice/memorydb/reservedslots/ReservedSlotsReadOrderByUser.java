...
public class ReservedSlotsReadOrderByUser implements ReadOrderBy<List<Slot>> {
    ...
    public ReservedSlotsReadOrderByUser(EntityFamilyReadingFabric entityFamilyReadingFabric, Read<Room> roomRead, Read<Person> personRead) {
