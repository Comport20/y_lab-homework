...
public class ReservedSlotReadOrderByPrice implements ReadOrderBy<List<Slot>> {
    ...
    public ReservedSlotReadOrderByPrice(EntityFamilyReadingFabric entityFamilyReadingFabric, Read<Room> roomRead, Read<Person> personRead) {
    ...
    public List<Slot> readOrderBy() {
        ...
        try (Connection con = ConnectionDB.getConnection()) {
            ...
            String readAllQuery = "SELECT * FROM entity.reserved_slot ORDER BY price";
